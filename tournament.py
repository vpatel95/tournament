...
=======
        ...
        print '==>  ' + str(rows[0]) + ' players are registered '
        'for tournament ' + tournament + '.'
>>>>>>> e8560216394549a828426fdd36b901cd05c59830:tournament.py
    db.commit()
    db.close()
    return rows[0]
