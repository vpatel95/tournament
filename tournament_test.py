...
def testCount():
    ...
    registerPlayer("ABC", "Jace Beleren")
    c = countPlayers("ABC")
    if c != 2:
        raise ValueError(
...
def testPairings():
    ...
    registerPlayer("ABC", "Rarity")
    registerPlayer("ABC", "Rainbow Dash")
    registerPlayer("ABC", "Princess Celestia")
    registerPlayer("ABC", "Princess Luna")
    standings = playerStandings()
    ...
    reportMatch("ABC", id1, id2, 'win')
    reportMatch("ABC", id3, id4, 'win')
    reportMatch("ABC", id5, id6, 'win')
    reportMatch("ABC", id7, id8, 'win')
    pairings = swissPairings()
    if len(pairings) != 4:
        raise ValueError(
            "For eight players, swissPairings should return 4 pairs. Got {pairs}".format(pairs=len(pairings)))
